...
bool Lambertian::scatter([[maybe_unused]] const Ray& in, const Point hit_point, const Vec3 &normal, Random &randomizer,
                        Ray &out, Color &attenuation) const
{
    // Distribution lies more heavily near the surface normal
    Vec3 random_dir = normal + randomizer.gen_uniform_unit_vec();
